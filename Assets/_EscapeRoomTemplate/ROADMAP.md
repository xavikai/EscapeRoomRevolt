...
Data de l'última auditoria: 10 d'agost de 2026
...
| Preparació comercial | Parcial | 12 tests EditMode i 13 PlayMode passant, assemblies separades i demo Escape Room funcionalment tancada; falten més EditMode, QA humà i l'inventari de llicències. |
...
Unity Test Framework executa 12 tests EditMode reals (`EventBus` i `LocalizationCatalog`) i 13 PlayMode reals. PlayMode cobreix codi, seqüència, llançament, canonades, lliscant, multi-fase, rodets —amb focus obligatori, gir bidireccional W/S i autoria dinàmica de 2–8 rodes—, perill mòbil en qualsevol direcció, temporitzador HUD independent, les sis opcions principals del menú i un round-trip Save/Load en memòria. Tots 25 passen; l'objectiu de 10 PlayMode està superat i falta arribar a 20 EditMode.
...
1. Cobertura parcial: 12 EditMode i 13 PlayMode (objectiu: 20 + 10); la part PlayMode ja supera el mínim.
...
Actualització 2026-08-10: qualsevol recompte antic dins l'historial extens de `P0-001` queda substituït pel resultat verificat actual, **12/12 EditMode i 13/13 PlayMode**. El mínim PlayMode ja està superat; només resta ampliar EditMode fins a 20.
...
| P0-006 | Documentació | Auditoria completa feta el 2026-08-09: `DOCUMENTACIO_COMPLETA.md`, `UserManual.md`, `PROGRAMMING_GUIDE.md`, checklist comercial i roadmap alineats amb sis escenes, ordre Intro/MainMenu, menú localitzat, creadors i nou inventari de puzles. Afegit `AUDITORIA_ESCAPE_ROOM_2026-08-09.md` com a registre sala per sala. Manteniment continu: actualitzar-la quan canviï una demo o un criteri de publicació. | README, UserManual, Programming Guide, documentació completa i roadmap descriuen la mateixa arquitectura, requisits i estat real. |
...
| P0-009 | Tancament Escape Room | Fet: definicions Throw/Melody i fases internes, porta + balisa al Pipe, prompts Sliding unificats, nomenclatura `New*`/`Cube` eliminada, sales renumerades i candau de la sala 13 reduït, amb focus obligatori, control W/S i autoria dinàmica de 2–8 rodes. Pendent: homogeneïtzar la segona peça de Placement i fer playthrough humà de museu/oficina des de build neta. | Cada puzle té definició, pistes i conseqüència visible; PlayMode supera el mínim. Falta QA humà i tancar Placement. |
